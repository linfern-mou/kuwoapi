...
| `GET/POST /song/url` | 歌曲元数据 | 待按 APK 接口改造 |
| `GET/POST /song/detail` | 歌曲详情 | 同 `/song/url` |
| `GET/POST /download` | 下载歌曲 | 待按 APK 接口改造 |
| `GET/POST /lyric` | 获取歌词 | `mlyric.kuwo.cn/mobi.s` |
| `GET/POST /rank` | 排行榜内容 | `kbangserver.kuwo.cn/ksong.s` |
| `GET/POST /rank/list` | 榜单列表 | `qukudata.kuwo.cn/q.k` |
